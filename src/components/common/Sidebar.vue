                ...
                <template v-if="item.children">
                    <el-submenu :index="item.routerPath" :key="item.menuId" >
                        ...
                        <template v-for="subItem in item.children">
                            <el-submenu v-if="subItem.hasChildren" :index="subItem.routerPath" :key="subItem.menuId" >
                                <template slot="title">{{ subItem.title }}</template>
                                <el-menu-item v-for="(threeItem,i) in subItem.children" :key="i"
                                 :index="threeItem.routerPath" :router='!threeItem.hasChildren'>
                                    {{ threeItem.title }}
                                </el-menu-item>
                            </el-submenu>
                            <el-menu-item v-else :index="subItem.routerPath" :key="subItem.menuId" >
                                {{ subItem.title }}
                            </el-menu-item>
                        </template>
                    </el-submenu>
